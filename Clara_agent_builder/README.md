\# Clara Agent Builder – Automation Assignment



This project implements an automated pipeline that converts

customer call transcripts into structured configurations for

a Clara AI voice agent.
...
These represent conversations where a customer explains
